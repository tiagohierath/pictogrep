...
func (s *server) routes() http.Handler {
	...
	mux.HandleFunc("GET /api/app/sync/library", s.syncLibrary)
	mux.HandleFunc("POST /api/app/sync/get", s.syncGetFromPeer)
	mux.HandleFunc("POST /api/app/sync/get/stop", s.syncStopGetting)
